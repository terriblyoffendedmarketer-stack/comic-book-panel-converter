#!/bin/bash
# Converts ALL comic files in the input/ folder for XTe Ink X4 (CrossPoint reader)
# Uses panel detection + grouping for optimal small-screen reading
...
echo "========================================"
echo "  XTe INK CONVERTER"
echo "  Converting all comics in input/"
echo "  (Panel detection + grouping)"
echo "========================================"
echo ""
